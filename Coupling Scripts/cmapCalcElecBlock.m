...
%     clearvars -except run;
    pdblist=char('Villin'); %modify to the name of the relevant PDB file
    BlockSize = 1;
...
%     system(cmd);
    ...
    hh9=fopen(cat(2,deblank(pdblist(run,:)),'_struct.txt'),'rt'); i=1; j=1; %secondary structure prediction file generated using STRIDE
    lkk=fgetl(hh9);
    while lkk > 0
